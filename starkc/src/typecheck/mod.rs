...
use crate::hir::{self, CoreType, ExprId, Hir, ItemId, PatId, Res, TypeId};
...
use types::{DeferredDisplayPlan, FnSigTy, GenericKind, VariantFields, VariantTy};

// Crate-internal pure helpers of the representation, used by the passes still in `mod.rs`.
use types::{ty_contains_error, ty_contains_infer, type_is_sized};
