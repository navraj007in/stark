# COMPILER-STATE archive — C0–C2 closed-gate detail

Verbatim material moved out of `COMPILER-STATE.md` on 2026-07-19 (C3-entry governance-repair
pass, CD-020) to satisfy the Charter §2.4 ~700-line state-file budget. Nothing here was
rewritten — sections were cut whole. The live state file keeps: the Position header, the full
append-only decision log, the conformance summary, the open-deviation index, gate exit
summaries, and the most recent session records. Canonical deviation detail lives in
`starkc/docs/conformance/KNOWN-DEVIATIONS.md`; gate-level evidence lives in
`starkc/docs/compiler/C0-exit-report.md` / `C1-exit-report.md` / `C2-exit-report.md`.

---

<!-- Archived from COMPILER-STATE.md lines 419-780 (known-deviation seed sections) -->
...
<!-- Archived from COMPILER-STATE.md lines 794-917 (WP-C1.3 deviation additions) -->
...
<!-- Archived from COMPILER-STATE.md lines 967-1033 (C0/C1-era file inventory) -->
...
<!-- Archived from COMPILER-STATE.md lines 1034-1108 (follow-ups list as of C2 close; the live file now carries only the open items) -->
## Follow-ups
...
<!-- Archived from COMPILER-STATE.md lines 1137-3065 (session records WP-C0.0 through Post-Gate-C2 correction brief Issue 5) -->
### WP-C0.0 — 2026-07-17
