...
- exactly-once expression evaluation and a construct-complete order table;
...
- ten manifest-triaged adversarial specification examples.

## Approved decisions

CORE-Q-006 is approved in full. CORE-Q-020 is approved for runtime ownership and destruction
of the pattern forms present in Core v1; C2.8 retains static pattern typing, exhaustiveness, and
...
chapters 02–06. The fixture extractor includes the new normative chapter; its ten examples are
manifest-triaged.
