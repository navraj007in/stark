...
| OWN-MOVE-001 | Which value uses move, copy, or borrow an operand? | partial/pending-classification | Abstract Machine §Operand Consumption | MEM-001/U17; none | ecosystem-breaking/C2.7 | Q006 pending/DEV-017 |
...
| OWN-PARTIAL-001 | Which field moves are permitted before later aggregate use or destruction? | partial/pending-classification | Abstract Machine §Partial Moves | none; none | ecosystem-breaking/C2.7 | Q006 pending/none |
| OWN-REINIT-001 | When does assignment reinitialize a moved place? | partial/pending-classification | Abstract Machine §Assignment | none; none | high/C2.7 | Q006 pending/none |
| EXEC-EVAL-001 | What is the evaluation order of operands, calls, indexing, and aggregates? | absent/pending-classification | Abstract Machine §Evaluation Order | none; none | ecosystem-breaking/C2.7 | Q006 pending/none |
| EXEC-PLACE-001 | Which expressions denote values versus places, and when are places read? | absent/pending-classification | Abstract Machine §Values and Places | none; none | ecosystem-breaking/C2.7 | Q006 pending/none |
| EXEC-TEMP-001 | When are temporaries created and destroyed on success and early exit? | absent/pending-classification | Abstract Machine §Temporaries | none; none | ecosystem-breaking/C2.7 | Q006 pending/none |
| EXEC-ASSIGN-001 | In what order are assignment target, right-hand side, old value, and write processed? | absent/pending-classification | Abstract Machine §Assignment | none; none | ecosystem-breaking/C2.7 | Q006 pending/none |
| DROP-EXACT-001 | Which initialized values are destroyed exactly once? | partial/pending-classification | Abstract Machine §Destruction | MEM-006/U17; none | ecosystem-breaking/C2.7 | Q006 pending/DEV-017 |
| DROP-ORDER-001 | What is destruction order for locals, fields, elements, parameters, and partial aggregates? | partial/pending-classification | Abstract Machine §Destruction Order | MEM-006/U17; none | ecosystem-breaking/C2.7 | Q006 pending/DEV-017 |
| DROP-ABORT-001 | Does a language trap perform destruction before termination? | partial/pending-classification | Abstract Machine §Trap Termination | MEM-006/U17; none | high/C2.7 | Q006,Q017 pending/DEV-017 |
...
| PAT-OWN-001 | Do pattern bindings move, copy, or borrow each matched component? | absent/pending-classification | Abstract Machine §Pattern Binding | none; none | ecosystem-breaking/C2.7 | Q020 pending/none |
| PAT-DROP-001 | What is destroyed when guards or later pattern alternatives fail? | absent/pending-classification | Abstract Machine §Pattern Failure | none; none | ecosystem-breaking/C2.7 | Q006,Q020 pending/none |
...
| TRAP-CATEGORY-001 | Which failures are STARK traps and which are host/process failures? | absent/pending-classification | Abstract Machine §Trap Categories | none; none | high/C2.7 | Q017 pending/none |
