...
| TYPE-FN-001 | Do function values participate in Eq/Ord/Hash, and is function identity observable? | complete/specified | 03 §Function Types | none; typecheck E0500 rejection | ecosystem-breaking/C4 | CD-027 approved (non-participation; identity unobservable)/DEV-061 |
| TYPE-FN-002 | May a generic function coerce to a concrete fn type, and with what semantics? | complete/specified | 03 §Function Types | none; none | high/C4 | CD-027 approved (instantiate at coercion)/DEV-061 |
