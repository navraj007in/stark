...
**Status:** **AUTHORISED AND ACTIVE — CD-400 (owner, 2026-08-12).** **AC2 is MET**; every other
criterion is open. AC3's repair has landed (DEV-235 RESOLVED, population A 10 -> 9) but its *exit*
