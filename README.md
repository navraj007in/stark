...
The repository carries 25 packages written in STARK under [`packages/`](packages/), each with its
...
* 25 first-party packages written in STARK, each with a consumer package that calls its declared
  surface;
