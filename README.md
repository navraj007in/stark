...
The repository carries 26 packages written in STARK under [`packages/`](packages/), each with its
...
* 26 first-party packages written in STARK, each with a consumer package that calls its declared
  surface;
