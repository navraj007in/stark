...
The repository carries 29 libraries plus the `stark-get` application under [`packages/`](packages/).
...
The package carries the 29 toolchain-marked first-party STARK libraries under
...
the provider ABI, 29 first-party libraries, six provider crates, a hash manifest and platform
installers; see
...
* 29 first-party libraries plus the `stark-get` application, with consumer packages that call the
