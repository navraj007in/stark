...
export const packages = {
  ...
  lede:
    'Twenty-six first-party packages live in the repository, each with its own manifest, lock file and tests, and each exercised by a consumer package that has to actually call the surface it declares. The deepest is an HTTP/1.1 and HTTPS client — written in the language, not bound to a C library.',
  groups: [
...
export const state = {
  ...
  working: [
    ...
    '26 first-party packages, including an HTTP/1.1 and HTTPS client',
