...
the compiler there are 26 first-party packages under `packages/`, capability-declared host access
...
- Packages and host access: **26 first-party packages live under `packages/`** (moved there
...
platforms) and compiler-backed language services done, over a qualified subset. 26 first-party
