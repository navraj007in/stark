...
the compiler there are 27 first-party packages under `packages/`, capability-declared host access
...
- Packages and host access: **27 first-party packages live under `packages/`** (moved there
...
platforms) and compiler-backed language services done, over a qualified subset. 27 first-party
